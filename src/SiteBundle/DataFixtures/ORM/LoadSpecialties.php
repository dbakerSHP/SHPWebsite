...
class LoadSpecialties extends AbstractFixture implements OrderedFixtureInterface
{
	...
	public function load(ObjectManager $manager)
	{
		...
		$specialty = new Specialties();
		$specialty->setSpecialty("Anesthesiology, Pain Management");
		$manager->persist($specialty);
		$manager->flush();
		...
		$specialty = new Specialties();
		$specialty->setSpecialty("Ear, Nose, and Throat");
		$manager->persist($specialty);
		$manager->flush();
		...
		$specialty = new Specialties();
		$specialty->setSpecialty("General Surgery, Surgical Oncology");
		$manager->persist($specialty);
		$manager->flush();
		...
		$specialty = new Specialties();
		$specialty->setSpecialty("Internal Medicine, Cardiology");
		$manager->persist($specialty);
		$manager->flush();

		$specialty = new Specialties();
		$specialty->setSpecialty("Internal Medicine, Sports Medicine");
		$manager->persist($specialty);
		$manager->flush();
		...
		$specialty = new Specialties();
		$specialty->setSpecialty("Ophthalmology, Plastic Surgery");
		$manager->persist($specialty);
		$manager->flush();
		...
		$specialty = new Specialties();
		$specialty->setSpecialty("Pain Management, Physical Medicine and Rehab");
		$manager->persist($specialty);
		$manager->flush();
		...
		$specialty = new Specialties();
		$specialty->setSpecialty("Allergy, Pulmonology");
		$manager->persist($specialty);
		$manager->flush();
		...
		$specialty = new Specialties();
		$specialty->setSpecialty("Radiology, Radiology - Interventional");
		$manager->persist($specialty);
		$manager->flush();
		...
		$specialty = new Specialties();
		$specialty->setSpecialty("General Surgery / Trauma-Crit Care");
		$manager->persist($specialty);
		$manager->flush();
