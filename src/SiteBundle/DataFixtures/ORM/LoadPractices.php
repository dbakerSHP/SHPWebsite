...
class LoadPractices extends Controller implements FixtureInterface
{
	...
	public function load(ObjectManager $manager)
	{
		...
		$practice = new Practices();
		$practice->setPractice("Cactus Pediatric Orthopedics");
		$manager->persist($practice);
		$manager->flush();
...
//		$practice->setPractice("GyneMedic")->setAddress1("9070 E. Desert Cove Ave.")->setAddress2("Ste. 102")->setCity("Scottsdale")->setState("AZ")->setZip("85260")->setLatitude("33.585610")->setLongitude("-111.884972")->setPhone("(480) 860-2322");
