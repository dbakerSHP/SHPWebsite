...
class LoadDefaultBusinesses implements FixtureInterface
{
	...
	public function load(ObjectManager $manager)
	{
		...
		$practice = new Practices();
		$practice->setPractice("21st Century Oncology of Arizona")->setAddress1("7340 E. Thomas Road")->setCity("Scottsdale")->setState("AZ")->setZip("85251")->setLatitude("33.48080")->setLongitude("-111.92263")->setPhone("(480) 945-6896");
		$manager->persist($practice);
		$manager->flush();
		...
		$practice = new Practices();
		$practice->setPractice("Advanced Fertility Care")->setAddress1("1701 E. Thomas Rd.")->setAddress2("Bldg 1, Ste. 202")->setCity("Phoenix")->setState("AZ")->setZip("85016")->setLatitude("33.47995")->setLongitude("-112.04486")->setPhone("(480) 874-2229");
		$manager->persist($practice);
		$manager->flush();
		...
		$practice = new Practices();
		$practice->setPractice("Affiliated Dermatology")->setAddress1("13995 W. Statler Blvd")->setAddress2("Suite 150")->setCity("Surprise")->setState("AZ")->setZip("85374")->setLatitude("33.62871")->setLongitude("-112.36137")->setPhone("(480) 556-0446");
		$manager->persist($practice);
		$manager->flush();

		$practice = new Practices();
		$practice->setPractice("Affiliated Dermatology")->setAddress1("19646 N. 27th Avenue")->setAddress2("Suite 305")->setCity("Phoenix")->setState("AZ")->setZip("85027")->setLatitude("33.66550")->setLongitude("-112.11826")->setPhone("(480) 556-0446");
		$manager->persist($practice);
		$manager->flush();
		...
		$practice = new Practices();
		$practice->setPractice("Affiliated Dermatology")->setAddress1("41810 N. Venture Drive")->setAddress2("Suite D136")->setCity("Anthem")->setState("AZ")->setZip("85086")->setLatitude("33.86411")->setLongitude("-112.14240")->setPhone("(480) 556-0446");
		$manager->persist($practice);
		$manager->flush();
		...
		$practice = new Practices();
		$practice->setPractice("Affiliated Urologists")->setAddress1("3330 N. 2nd St.")->setAddress2("Ste. 601")->setCity("Phoenix")->setState("AZ")->setZip("85012")->setLatitude("33.48678")->setLongitude("-112.07169")->setPhone("(602) 264-0608");
		$manager->persist($practice);
		$manager->flush();
		...
		$practice = new Practices();
		$practice->setPractice("Allergy, Asthma, and Immunology Associates")->setAddress1("3800 N. Central Ave.")->setAddress2("Ste. 404")->setCity("Phoenix")->setState("AZ")->setZip("85012")->setLatitude("33.49174")->setLongitude("-112.07448")->setPhone("(602) 248-9129");
		$manager->persist($practice);
		$manager->flush();
		...
		$practice = new Practices();
		$practice->setPractice("Arizona Asthma and Allergy Institute")->setAddress1("13026 W. Rancho Santa Fe Blvd.")->setAddress2("Suite A-100")->setCity("Avondale")->setState("AZ")->setZip("85392")->setLatitude("33.46235")->setLongitude("-112.33623")->setPhone("(623) 935-3000");
		$manager->persist($practice);
		$manager->flush();
		...
		$practice = new Practices();
		$practice->setPractice("Arizona Asthma and Allergy Institute")->setAddress1("3200 E. Camelback")->setAddress2("Suite")->setCity("Phoenix")->setState("AZ")->setZip("85018")->setLatitude("33.51071")->setLongitude("-112.01162")->setPhone("(602) 734-0370");
		$manager->persist($practice);
		$manager->flush();
		...
		$practice = new Practices();
		$practice->setPractice("Arizona Asthma and Allergy Institute")->setAddress1("5605 W. Eubie Ave.")->setAddress2("Suite 200")->setCity("Glendale")->setState("AZ")->setZip("85304")->setLatitude("33.60708")->setLongitude("-112.18150")->setPhone("(602) 843-2991");
		$manager->persist($practice);
		$manager->flush();

		$practice = new Practices();
		$practice->setPractice("Arizona Bone and Joint Specialists")->setAddress1("13640 N. 7th St.")->setCity("Phoenix")->setState("AZ")->setZip("85022")->setLatitude("33.61099")->setLongitude("-112.06601")->setPhone("(602) 863-2040");
		$manager->persist($practice);
		$manager->flush();
		...
		$practice = new Practices();
		$practice->setPractice("Arizona Cardiology Group")->setAddress1("1988 E Baseline")->setAddress2("Suite 101")->setCity("Tempe")->setState("AZ")->setZip("85283")->setLatitude("33.37909")->setLongitude("-111.90104")->setPhone("(602) 386-1100");
		$manager->persist($practice);
		$manager->flush();
		...
		$practice = new Practices();
		$practice->setPractice("Arizona Cardiology Group")->setAddress1("340 E Palm Lane")->setAddress2("Suite 175")->setCity("Phoenix")->setState("AZ")->setZip("85004")->setLatitude("33.46994")->setLongitude("-112.06835")->setPhone("(602) 368-1112");
		$manager->persist($practice);
		$manager->flush();

		$practice = new Practices();
		$practice->setPractice("Arizona Cardiovascular and Thoracic Surgeons")->setAddress1("13943 North 91st Ave")->setAddress2("Suite B101")->setCity("Peoria")->setState("AZ")->setZip("85381")->setLatitude("33.61030")->setLongitude("-112.25421")->setPhone("(623) 476-5190");
		$manager->persist($practice);
		$manager->flush();
		...
		$practice = new Practices();
		$practice->setPractice("Arizona Center for Cancer Care")->setAddress1("14155 N. 83rd Ave.")->setAddress2("Ste. 127")->setCity("Peoria")->setState("AZ")->setZip("85381")->setLatitude("33.61281")->setLongitude("-112.23679")->setPhone("(623) 773-2873");
		$manager->persist($practice);
		$manager->flush();

		$practice = new Practices();
		$practice->setPractice("Arizona Center for Cancer Care")->setAddress1("14674 W. Mountain View Blvd.")->setAddress2("Ste. 127")->setCity("Surprise")->setState("AZ")->setZip("85374")->setLatitude("33.65542")->setLongitude("-112.37668")->setPhone("(623) 466-7469");
		$manager->persist($practice);
		$manager->flush();

		$practice = new Practices();
		$practice->setPractice("Arizona Center for Cancer Care")->setAddress1("20950 N. 29th Ave.")->setCity("Phoenix")->setState("AZ")->setZip("85027")->setLatitude("33.67602")->setLongitude("-112.12079")->setPhone("(480) 278-8300");
		$manager->persist($practice);
		$manager->flush();

		$practice = new Practices();
		$practice->setPractice("Arizona Center for Cancer Care")->setAddress1("3645 S. Rome St.")->setAddress2("Ste. 116")->setCity("Gilbert")->setState("AZ")->setZip("85297")->setLatitude("33.28478")->setLongitude("-111.75031")->setPhone("(480) 278-8300");
		$manager->persist($practice);
		$manager->flush();
		...
		$practice = new Practices();
		$practice->setPractice("Arizona Digestive Health")->setAddress1("9755 N. 90th St")->setAddress2("Suite A205")->setCity("Scottsdale")->setState("AZ")->setZip("85258")->setLatitude("33.57460")->setLongitude("-111.88569");
		$manager->persist($practice);
		$manager->flush();
		...
		$practice = new Practices();
		$practice->setPractice("Arizona Eye Specialists")->setAddress1("13555 W. McDowell Rd.")->setAddress2("Ste. 102")->setCity("Goodyear")->setState("AZ")->setZip("85395")->setLatitude("33.46390")->setLongitude("-112.35101")->setPhone("(623) 209-0020");
		$manager->persist($practice);
		$manager->flush();

		$practice = new Practices();
		$practice->setPractice("Arizona Eye Specialists")->setAddress1("300 E. Osborn Rd.")->setAddress2("Ste. 100")->setCity("Phoenix")->setState("AZ")->setZip("85012")->setLatitude("33.48799")->setLongitude("-112.06880")->setPhone("(602) 254-7255");
		$manager->persist($practice);
		$manager->flush();

		$practice = new Practices();
		$practice->setPractice("Arizona Eye Specialists")->setAddress1("4915 E. Baseline Rd.")->setAddress2("Ste. 114")->setCity("Gilbert")->setState("AZ")->setZip("85234")->setLatitude("33.37887")->setLongitude("-111.83471")->setPhone("(489) 830-0120");
		$manager->persist($practice);
		$manager->flush();

		$practice = new Practices();
		$practice->setPractice("Arizona Eye Specialists")->setAddress1("5620 W. Thunderbird Rd.")->setAddress2("Ste. H-3")->setCity("Glendale")->setState("AZ")->setZip("85306")->setLatitude("33.61167")->setLongitude("-112.17987")->setPhone("(602) 547-2002");
		$manager->persist($practice);
		$manager->flush();
		...
		$practice = new Practices();
		$practice->setPractice("Arizona Hand and Wrist Specialists")->setAddress1("2940 E Banner Gateway Dr.")->setAddress2("Suite 350")->setCity("Gilbert")->setState("AZ")->setZip("85234")->setLatitude("33.38416")->setLongitude("-111.72574")->setPhone("(602) 393-1010");
		$manager->persist($practice);
		$manager->flush();
		...
		$practice = new Practices();
		$practice->setPractice("Arizona Neurological Institute")->setAddress1("13640 North 99th Ave")->setAddress2("Suite 100")->setCity("Sun City")->setState("AZ")->setZip("85351")->setLatitude("33.60851")->setLongitude("-112.27045")->setPhone("(623) 972-3800");
		$manager->persist($practice);
		$manager->flush();
		...
		$practice = new Practices();
		$practice->setPractice("Arizona Oncology Associates")->setAddress1("2222 E. Highland Ave")->setAddress2("Suite 400")->setCity("Phoenix")->setState("AZ")->setZip("85016")->setLatitude("33.50634")->setLongitude("-112.03388")->setPhone("(602) 277-4868");
		$manager->persist($practice);
		$manager->flush();

		$practice = new Practices();
		$practice->setPractice("Arizona Oncology Services")->setAddress1("19646 N 27th Ave")->setAddress2("Ste. 108")->setCity("Phoenix")->setState("AZ")->setZip("85027")->setLatitude("33.66550")->setLongitude("-112.11826")->setPhone("(602) 240-3503");
		$manager->persist($practice);
		$manager->flush();

		$practice = new Practices();
		$practice->setPractice("Arizona Orthopedic and Sports Medicine Specialists")->setAddress1("2222 E. Highland Ave.")->setAddress2("Ste. 425")->setCity("Phoenix")->setState("AZ")->setZip("85016")->setLatitude("33.50634")->setLongitude("-112.03388")->setPhone("(602) 667-6640");
		$manager->persist($practice);
		$manager->flush();
		...
		$practice = new Practices();
		$practice->setPractice("Associated Retina Consultants")->setAddress1("15353 N 91st Ave.")->setCity("Peoria")->setState("AZ")->setZip("85381")->setLatitude("33.62364")->setLongitude("-112.25404")->setPhone("(602) 242-4928");
		$manager->persist($practice);
		$manager->flush();

		$practice = new Practices();
		$practice->setPractice("Associated Retina Consultants")->setAddress1("1750 E. Glendale Ave.")->setCity("Phoenix")->setState("AZ")->setZip("85020")->setLatitude("33.53888")->setLongitude("-112.04424")->setPhone("(602) 242-4928");
		$manager->persist($practice);
		$manager->flush();
		...
		$practice = new Practices();
		$practice->setPractice("Bertrand P Kaper, MD PC")->setAddress1("3655 Crossings Drive")->setCity("Prescott")->setState("AZ")->setZip("86305")->setLatitude("34.59663")->setLongitude("-112.46709")->setPhone("(928) 778-9250");
		$manager->persist($practice);
		$manager->flush();
		...
		$practice = new Practices();
		$practice->setPractice("Cardiologists of Scottsdale")->setAddress1("7970 E. Thompson Peak Pkwy.")->setAddress2("Ste. 101")->setCity("Scottsdale")->setState("AZ")->setZip("85255")->setLatitude("33.67149")->setLongitude("-111.90994")->setPhone("(480) 419-9033");
		$manager->persist($practice);
		$manager->flush();
		...
		$practice = new Practices();
		$practice->setPractice("Cardiovascular Consultants")->setAddress1("16222 N. 59th Avenue")->setAddress2("Suite A100")->setCity("Glendale")->setState("AZ")->setZip("85306")->setLatitude("33.63312")->setLongitude("-112.18602")->setPhone("(623) 334-4000");
		$manager->persist($practice);
		$manager->flush();

		$practice = new Practices();
		$practice->setPractice("Cardiovascular Consultants")->setAddress1("18700 N. 64th Drive")->setAddress2("Suite 101")->setCity("Glendale")->setState("AZ")->setZip("85308")->setLatitude("33.65519")->setLongitude("-112.20053")->setPhone("(623) 561-6211");
		$manager->persist($practice);
		$manager->flush();

		$practice = new Practices();
		$practice->setPractice("Cardiovascular Consultants")->setAddress1("19646 N. 27th Avenue")->setAddress2("Suite 408")->setCity("Phoenix")->setState("AZ")->setZip("85027")->setLatitude("33.66550")->setLongitude("-112.11826")->setPhone("(623) 582-1465");
		$manager->persist($practice);
		$manager->flush();

		$practice = new Practices();
		$practice->setPractice("Cardiovascular Consultants")->setAddress1("2905 West Warner Road")->setAddress2("Suite 12")->setCity("Chandler")->setState("AZ")->setZip("85224")->setLatitude("33.33392")->setLongitude("-111.89129");
		$manager->persist($practice);
		$manager->flush();
		...
		$practice = new Practices();
		$practice->setPractice("Cardiovascular Consultants")->setAddress1("3624 W. Anthem Way")->setAddress2("Suite C100")->setCity("Anthem")->setState("AZ")->setZip("85086")->setLatitude("33.48898")->setLongitude("-111.92584")->setPhone("(623) 551-2866");
		$manager->persist($practice);
		$manager->flush();
		...
		$practice = new Practices();
		$practice->setPractice("Cardiovascular Consultants")->setAddress1("5422 W. Thunderbird Road")->setAddress2("Suite 8")->setCity("Glendale")->setState("AZ")->setZip("85306")->setLatitude("33.61124")->setLongitude("-112.17633")->setPhone("(602) 978-0698");
		$manager->persist($practice);
		$manager->flush();

		$practice = new Practices();
		$practice->setPractice("Cardiovascular Consultants")->setAddress1("5620 W. Thunderbird Road")->setAddress2("Suite E4")->setCity("Glendale")->setState("AZ")->setZip("85306")->setLatitude("33.61167")->setLongitude("-112.17987")->setPhone("(602) 652-8780");
		$manager->persist($practice);
		$manager->flush();

		$practice = new Practices();
		$practice->setPractice("Cardiovascular Consultants")->setAddress1("6036 N. 19th Avenue")->setAddress2("Ste. 312")->setCity("Phoenix")->setState("AZ")->setZip("85015")->setLatitude("33.52577")->setLongitude("-112.10059")->setPhone("(602) 246-5570");
		$manager->persist($practice);
		$manager->flush();

		$practice = new Practices();
		$practice->setPractice("Cardiovascular Consultants")->setAddress1("606 North Country Club Drive")->setAddress2("Suite 4")->setCity("Mesa")->setState("AZ")->setZip("85201")->setLatitude("33.42648")->setLongitude("-111.84034");
		$manager->persist($practice);
		$manager->flush();
		...
		$practice = new Practices();
		$practice->setPractice("Cardiovascular Consultants")->setAddress1("9100 N. 2nd Street")->setAddress2("Suite 321")->setCity("Phoenix")->setState("AZ")->setZip("85020")->setLatitude("33.56905")->setLongitude("-112.07217")->setPhone("(602) 870-1789");
		$manager->persist($practice);
		$manager->flush();
		...
		$practice = new Practices();
		$practice->setPractice("Center for Dermatology, PC")->setAddress1("740 E Highland Ave")->setAddress2("Ste 100")->setCity("Phoenix")->setState("AZ")->setZip("85014")->setLatitude("33.50599")->setLongitude("-112.06338")->setPhone("(480) 905-8485");
		$manager->persist($practice);
		$manager->flush();
		...
		$practice = new Practices();
		$practice->setPractice("Comprehensive Breast Center of Arizona")->setAddress1("19646 N. 27th Avenue")->setAddress2("Suite 403")->setCity("Phoenix")->setState("AZ")->setZip("85027")->setLatitude("33.66550")->setLongitude("-112.11826")->setPhone("(602) 374-3440");
		$manager->persist($practice);
		$manager->flush();

		$practice = new Practices();
		$practice->setPractice("Comprehensive Breast Center of Arizona")->setAddress1("9179 W. Thunderbird Rd.")->setAddress2("Ste. 103")->setCity("Peoria")->setState("AZ")->setZip("85381")->setLatitude("33.60844")->setLongitude("-112.25709")->setPhone("(602) 374-3440");
		$manager->persist($practice);
		$manager->flush();
		...
		$practice = new Practices();
		$practice->setPractice("Specialty Orthopedic Surgery")->setAddress1("9700 N. 91st St.")->setAddress2("Ste. B108")->setCity("Scottsdale")->setState("AZ")->setZip("85258")->setLatitude("33.57369")->setLongitude("-111.88347")->setPhone("(602) 466-7378");
		$manager->persist($practice);
		$manager->flush();
